 ...
 */
class IntegerDescription extends AttributeDescription {

  IntegerDescription(String name, Configuration c) throws ClassNotFoundException {
    attributeName = name;
    attributeClass = Class.forName("jboost.examples.IntegerAttribute");
